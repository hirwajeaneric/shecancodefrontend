import benigne from "../../assets/alumin/IMG-20230724-WA0011.jpg";
import happy from "../../assets/alumin/happy.jpg";
import alumin3 from "../../assets/alumin/doreen.jpg";
import Angelique from "../../assets/alumin/Angelique.jpg";
...
const graduatesData = [
  ...
  },
  {
    ...
    imageSrc: happy,
    content:
      "I am aspiring to be a frontend developer through taking an advantage of the Shecancode Bootcamp of the desire to enhance my abilities,learn and connect with industry professional influence in on my way to make a substantial influence in the tech industry through coding with purpose. I highly inspire others who wants to realize their full potential and make a difference in the world of technology to join Shecancode Bootcamp",
  },
  {
